                ...
                <h2 class="subtitle">
                  ...
                  <form action="{{ route('people.update', ['id' => $person->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @component('components.form.inputtext')
                        ...
                        @slot('value') {{ $person->first_name }} @endslot
                    ...
                    @component('components.form.inputtext')
                        ...
                        @slot('value') {{ $person->last_name }} @endslot
                        @slot('fa_icon') fas fa-user @endslot
                    @endcomponent
                    ...
                    @component('components.form.inputtext')
                        ...
                        @slot('value') {{ $person->bith_year }} @endslot
        ...
        <section class="section">
            <div class="container">
                ...
                @component('components.form.inputtext')
                    ...
                    @slot('value') {{ $person->address->country }} @endslot
                ...
                @component('components.form.inputtext')
                    ...
                    @slot('value') {{ $person->address->city }} @endslot
                ...
                @component('components.form.inputtext')
                    ...
                    @slot('value') {{ $person->address->street }} @endslot
                ...
                @component('components.form.inputtext')
                    ...
                    @slot('value') {{ $person->address->house }} @endslot
        ...
        <section class="section">
            <div class="container">
                ...
                @component('components.form.textarea')
                    ...
                    @slot('value') {{ $person->info->info }} @endslot
                @endcomponent
            </div>
        </section>
        <hr>
